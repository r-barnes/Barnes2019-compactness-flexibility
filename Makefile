...
# 	cd ..
	...
	#TODO
# 	./bin/augmenter.exe output/cb_2015_us_cd114_500k_reproj.shp output/cb_2015_us_state_500k_reproj.shp data/cb_2015_us_cd114_500k_scored.shp STATEFP
# 	./bin/augmenter.exe output/cb_2015_us_cd114_5m_reproj.shp   output/cb_2015_us_state_5m_reproj.shp   data/cb_2015_us_cd114_5m_scored.shp   STATEFP
# 	./bin/augmenter.exe output/cb_2015_us_cd114_20m_reproj.shp  output/cb_2015_us_state_20m_reproj.shp  data/cb_2015_us_cd114_20m_scored.shp  STATEFP
	#Process data
	./res_bounded.py            output/cb_2015_us_cd114_500k_reproj.shp output/cb_2015_us_state_500k_reproj.shp data/cb_2015_us_cd114_500k_scored.shp STATEFP
	...
	./res_fig_gerrymandering.py data/cb_2015_us_cd114_500k.shp data/cb_2015_us_state_500k.shp
